...
namespace ariel
{
    ...
    public:
        ...
        ~Ninja(); // destructor
        void move (Ninja *enemy);  // receives a pointer to the enemy and moves towards the enemy. The ninja advances a distance equal to its speed
        void slash(Ninja *enemy);  // Receives a pointer to the enemy. If the ninja is alive and the enemy is less than 1 meter away 
        // print
